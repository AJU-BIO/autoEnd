function createPurchaseModal() {
  ...
  const checkList = [
    "1. 오토소싱은 최초 55만원 구매 후 , 1년 뒤부터는 월 요금 5.5만원(변동가능)이 부과됩니다.<br><i class='fsz-xsm'>최초 구매비용은 서버 및 DB 세팅비용으로 환불이 불가합니다.</i>",
    "2. 오토소싱은 브랜드 및 지재권 확인 기능이 없으니, 금지어를 참고해 사용자가 직접 판단해야 합니다.",
    "3. 자동 생성된 상품명은 검토가 필요하며, 무게(배송비)는 직접 입력해야 합니다.",
    "4. 외부적인요인 또는 기술적인 문제로 7일 이상 서비스 불가시, 구매 비용에서 일할계산하여 환불됩니다.",
    "5. 1인 1프로그램 사용 원칙이며, 무단 배포 및 공동 사용 시 법적 책임이 발생할 수 있습니다.",
  ];
